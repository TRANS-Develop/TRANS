...
public class TRANSAverageStrideRecordReader extends RecordReader<IntWritable,StrideAverageResult>{
	public Map<Integer,StrideAverageResult> values = new HashMap<Integer,StrideAverageResult>();

	private Counter c = null;
	OptimusDataProtocol dp  = null;
	PartitionReader reader = null;
	StrideAverageResult [] result = null;
	int cur = -1;
	@Override
	public void initialize(InputSplit arg0, TaskAttemptContext context)
		...
		AverageResultArrayWritable ret = dp.readStrideAverage(p, split.getPshape(), split.getStart(), 
				split.getOff(), split.getStride());
		result = (StrideAverageResult[]) ret.getResult();
	...
	@Override
	public StrideAverageResult getCurrentValue() throws IOException,
