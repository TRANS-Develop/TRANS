...
public class StrideAverage {
	public static void main(String[] args) throws Exception {
		...
		job.setInputFormatClass(TRANS.MR.Average.io.TransStrideAverageInputFormat.class);
		job.setJarByClass(StrideAverage.class);
		job.setCombinerClass(TRANS.MR.Average.combiner.StrideAverageCombiner.class);
		job.setMapperClass(TRANS.MR.Average.Mapper.StrideAverageMapper.class);
		job.setReducerClass(TRANS.MR.Average.Reducer.StrideAverageReducer.class);

		job.setMapOutputKeyClass(IntWritable.class);
		job.setMapOutputValueClass(StrideAverageResult.class);
